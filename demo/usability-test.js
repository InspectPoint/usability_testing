...
(function () {
  ...
  var TEST_NAME = "Demo";  // labels every result row; keep stable across reruns — separate bucket from the live "Components: Setup" test so demo/walkthrough clicks never mix into real participant data
